...
import type { AnswerFeedback, ShortAnswerBlock } from '@questly/lesson-dsl';

@Component({
  selector: 'app-short-answer-block',
  template: `
...
export class ShortAnswerBlockComponent {
  readonly block = input.required<ShortAnswerBlock>();
